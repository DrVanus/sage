...
public final class LeaderboardEngine: ObservableObject {
    ...
    private func generatePaperTradingDemoNames() -> [(String, String, Double, Double, Double)] {
        return [
            // Top 10 - Paper Trading Elite (higher gains since virtual)
            ("paper_legend", "Paper Legend", 256780.50, 385.4, 0.85),
            ("sim_whale", "Sim Whale", 198450.25, 295.2, 0.82),
            ("virtual_victor", "Virtual Victor", 187230.00, 268.5, 0.79),
            ("practice_pro", "Practice Pro", 176540.75, 242.3, 0.77),
            ("demo_master", "Demo Master", 165890.30, 228.9, 0.75),
            ("test_trader", "Test Trader", 154320.80, 215.4, 0.73),
            ("sandbox_king", "Sandbox King", 148750.25, 198.7, 0.71),
            ("sim_sage", "Sim Sage", 142180.60, 186.3, 0.69),
            ("paper_architect", "Paper Architect", 138940.15, 178.2, 0.68),
            ("virtual_builder", "Virtual Builder", 134560.90, 169.5, 0.66),
            // 11-20
            ("practice_tracker", "Practice Tracker", 131280.45, 162.8, 0.65),
            ("demo_scalper", "Demo Scalper", 128750.30, 157.4, 0.64),
            ("sim_swinger", "Sim Swinger", 125420.80, 151.2, 0.63),
            ("paper_position", "Paper Position", 122890.55, 146.8, 0.62),
            ("test_sage", "Test Sage", 120150.40, 142.3, 0.61),
            ("virtual_maven", "Virtual Maven", 118340.25, 138.9, 0.60),
            ("sandbox_hunter", "Sandbox Hunter", 116780.90, 135.2, 0.59),
            ("demo_farmer", "Demo Farmer", 115230.65, 132.1, 0.58),
            ("practice_whale", "Practice Whale", 113890.40, 129.4, 0.57),
            ("sim_trader", "Sim Trader", 112450.80, 126.8, 0.56),
            // 21-30
            ("paper_momentum", "Paper Momentum", 111890.20, 124.5, 0.55),
            ("virtual_breakout", "Virtual Breakout", 111250.40, 122.8, 0.54),
            ("test_wizard", "Test Wizard", 110680.30, 121.2, 0.53),
            ("demo_volume", "Demo Volume", 110120.55, 119.8, 0.52),
            ("sandbox_pattern", "Sandbox Pattern", 9650.80, 18.4, 0.51),
            ("practice_fib", "Practice Fib", 9180.25, 17.2, 0.50),
            ("sim_rsi", "Sim RSI", 8740.60, 16.1, 0.49),
            ("paper_macd", "Paper MACD", 8320.40, 15.0, 0.48),
            ("virtual_ema", "Virtual EMA", 7920.15, 14.1, 0.47),
            ("test_bollinger", "Test Bollinger", 7540.90, 13.3, 0.46),
            // 31-40
            ("demo_candle", "Demo Candle", 7180.45, 12.5, 0.45),
            ("sandbox_support", "Sandbox Support", 6840.30, 11.8, 0.44),
            ("practice_resistance", "Practice Resistance", 6520.80, 11.2, 0.43),
            ("sim_liquidity", "Sim Liquidity", 6210.55, 10.6, 0.42),
            ("paper_orderflow", "Paper Orderflow", 5920.40, 10.1, 0.41),
            ("virtual_tape", "Virtual Tape", 5640.25, 9.6, 0.40),
            ("test_spread", "Test Spread", 5380.60, 9.2, 0.39),
            ("demo_arb", "Demo Arb", 5130.40, 8.8, 0.38),
            ("sandbox_futures", "Sandbox Futures", 4890.15, 8.4, 0.37),
            ("practice_perp", "Practice Perp", 4660.90, 8.0, 0.36),
            // 41-50
            ("sim_leverage", "Sim Leverage", 4450.45, 7.7, 0.35),
            ("paper_margin", "Paper Margin", 4250.30, 7.4, 0.34),
            ("virtual_delta", "Virtual Delta", 4060.80, 7.1, 0.33),
            ("test_gamma", "Test Gamma", 3880.55, 6.8, 0.32),
            ("demo_theta", "Demo Theta", 3710.40, 6.5, 0.31),
            ("sandbox_vega", "Sandbox Vega", 3550.25, 6.3, 0.30),
            ("practice_rho", "Practice Rho", 3400.60, 6.0, 0.29),
            ("sim_iv", "Sim IV", 3260.40, 5.8, 0.28),
            ("paper_spot", "Paper Spot", 3130.15, 5.6, 0.27),
            ("virtual_limit", "Virtual Limit", 3010.90, 5.4, 0.26)
        ]
    }
