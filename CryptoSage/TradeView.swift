...
struct TradeView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // Switch the ViewModel to the current symbol
            priceVM.updateSymbol(symbol)
            priceVM.startLiveUpdates(coinID: symbol.lowercased())
        ...
        .onChange(of: symbol) { newSymbol in
            ...
            // Switch the ViewModel to the new symbol
            priceVM.updateSymbol(newSymbol)
            priceVM.startLiveUpdates(coinID: newSymbol.lowercased())
